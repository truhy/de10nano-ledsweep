...
#make -C "$APP_HOME_PATH/scripts-linux/uboot" --no-print-directory -f Makefile-prep-ub.mk release
...
#cp -f -u $UBOOT_OUT_PATH/u-boot/u-boot-with-spl.sfp $APP_HOME_PATH/scripts-linux/Debug/uboot
#cp -f -u $UBOOT_OUT_PATH/u-boot/u-boot-with-spl.sfp $APP_HOME_PATH/scripts-linux/Release/uboot
