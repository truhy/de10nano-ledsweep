...
#if defined(TRU_CFG_MMU) && TRU_CFG_MMU == 1U
  // Invalidate entire Unified TLB
  __set_TLBIALL(0);
#endif

#if defined(TRU_CFG_L1C) && TRU_CFG_L1C == 1U
...
#if defined(TRU_CFG_FPU) && TRU_CFG_FPU == 1U && __FPU_PRESENT == 1U && __FPU_USED == 1U
  __FPU_Enable();
#endif

#if defined(TRU_CFG_MMU) && TRU_CFG_MMU == 1U
  MMU_CreateTranslationTable();
#if defined(TRU_CFG_NONCACHEABLE_SECTION) && TRU_CFG_NONCACHEABLE_SECTION == 1U
...
#if defined(TRU_CFG_L2C) && TRU_CFG_L2C == 1U && __L2C_PRESENT == 1U
